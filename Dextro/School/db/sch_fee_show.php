	...
	<div class="post-content">
		<div class="post-text">
				...
				<!-- <form class="fee_chng_form" name="fee-change"  method="POST"> -->
					...
					<div class="box-left" style="height:140px;width:90%;" >
	...
	<div class="main-container ">
		 <div class="post-header">
		 	...
		 	<div class="post-text" style="margin:5px;">
                            <button class="sch_fee_verify" onclick="discClicked()" style="margin-left:370px;" >Submit</button>
			</div>
			...
			<?php
				...
				if(mysqli_num_rows($query)!=0){
					while($fees=mysqli_fetch_row($query)){
											...
											{
                                                $check_bal = mysqli_query($con,"SELECT bal FROM `bal_amt` where Gr_num ='".$grn['sch_grn']."'");
											}
