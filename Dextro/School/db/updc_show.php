...
if(mysqli_num_rows($result)!=0){
	...
	//echo $key;
				...
				<div class="check-box box-left">
				 <input  type="checkbox" class="check-select-all" value="<?php echo 'update-'.$div ?>">
					<label class="checkbox-text">Select All</label> 
						<span class="check-box-span" style="width: 449px;height: 141px;">
				 <?php
		}
		else{
		?>
		...
		?>
							 ...
							 <input type="checkbox" name="<?php echo 'update-'.$div ?>" value="<?php echo $val[1] ?>"> 
                                                         <span class="" > 
									<?php print_r($val[1]);?>
								</span>	
								<span class="box-check-span" style=" width:100px;">
									<?php print_r($val[3]);?>
								</span>
