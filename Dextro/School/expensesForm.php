...
?>
<div class="span-right" style="width: 1004px;padding-left: 150px;border:solid">
			...
			<!-- <div class="post-header" style="width: 700px;">
			 ...
			 <form class="sch_ads" method="post" action="" style="margin-top: 30px;margin-bottom: 0px;width: 700px;">
                             <div style="text-align:center">
                                 <b><p style="margin-top: 0px; margin-bottom: 0px;text-align:center">Acknowledgement</p></b>
                                 </br><hr></br>
                             </div>
                                    <div class="main-container" style="width: 800px;margin-left: 0px;height: 245px;">
                               
                                        <div style="display:flex;margin-left: 110px;">
                                        <div style="width: 300px;"> 
                                            <div style="display:flex;margin-left: 0px;FONT-FAMILY: initial;font-weight: 500;font-size: 20px;">
