...
?>
		...
		$query=mysqli_query($con,"select admin_sch.Name,expenses.receipt_no,expenses.to,"
                        . "expenses.mode,expenses.cheque_no,expenses.amount,expenses.remark,expenses.date "
                        . "from expenses INNER JOIN admin_sch ON expenses.unique_id=admin_sch.unique_id order by date DESC limit 20");
		$i=0;
