...
<?php
		...
		//	echo $count;
			if($id[1]=='Per Year'){
                ...
                $income=0;
		$query=mysqli_query($con,"SELECT amount, late_fee, lflag FROM adm_sch_tran UNION ALL SELECT amount, late_fee, lflag
                         FROM sch_tran");
		$i=0;
		while($jd=mysqli_fetch_row($query)){
			...
			if($jd[2]=='Yes'){
                ...
                $query1=mysqli_query($con,"SELECT * FROM adm_sch_tran where date= CURRENT_DATE() union all Select * from sch_tran where date= CURRENT_DATE()");
		$today=0;
				...
				<div class="post-text">
					<ul class="home-menu">
						...
						<a class="home-menu-link" href="today.php">
							<li class="home-menu-li">
								<span>
                                                                        <?php echo ("Todays Transactions= ".$today)?>
								</span>
							</li>
						</a>
