					...
					<div class="box-right">
						 Fee type: <select name="adm_set_fee_type">
							 ...
							 <option value="Admission Fee">Admission</option>
                                 <option value="Term 1 fee">Term 1</option>
								 <option value="Term 2 fee">Term 2</option>
								 <option value="Other Term 1">Other Term1</option>
								 <option value="Other Term 2">Other Term2</option>
								 <option value="Other Term 3">Other Term3</option>
